package com.example.aicodemother.langgraph4j.tools;
...
import com.example.aicodemother.langgraph4j.model.enums.ImageCategoryEnum;
    ...
    public List<ImageResource> searchIllustrations(@P("搜索关键词") String query) {
        ...
        try (HttpResponse response = HttpRequest.get(apiUrl).timeout(10000).execute()) {
            ...
            for (int i = 0; i < actualCount; i++) {
                ...
                if (CharSequenceUtil.isNotBlank(media)) {
